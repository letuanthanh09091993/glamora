...
const translations = {
  VN: {
    ...
    home: {
      ...
      signedInHint: "Tìm artist, xem hồ sơ và đặt lịch — quản lý tài khoản từ menu.",
      searchPlaceholder: "Tìm theo tên, chuyên môn, địa điểm...",
      searchLabel: "Tìm chuyên viên",
      exploreTitle: "Khám phá artist",
      exploreSubtitle: "Lướt danh sách makeup artist công khai trên Glamora.",
      quickBookTitle: "Đặt lịch nhanh",
      quickBookBody: "Chọn artist yêu thích và gửi yêu cầu chỉ trong vài bước.",
    ...
    booking: {
      title: "Đặt lịch",
      subtitle: "Chọn thời gian và mô tả nhu cầu. Artist sẽ xác nhận lịch của bạn.",
      navLink: "Lịch hẹn",
      ...
      withArtist: "Với artist",
      withCustomer: "Khách hàng",
      dateLabel: "Ngày",
      timeLabel: "Giờ bắt đầu",
      durationLabel: "Thời lượng (phút)",
      notesLabel: "Ghi chú / Dịch vụ mong muốn",
      notesPlaceholder: "Ví dụ: makeup cô dâu, tone tự nhiên...",
      submit: "Gửi yêu cầu",
      successCreated: "Đã gửi yêu cầu đặt lịch.",
      backToProfile: "Về hồ sơ artist",
      loginRequired: "Vui lòng đăng nhập bằng tài khoản khách hàng để đặt lịch.",
      wrongRole: "Chỉ khách hàng mới có thể đặt lịch với makeup artist.",
      artistNotFound: "Không tìm thấy makeup artist.",
      notArtist: "Người dùng này không phải makeup artist.",
      cannotBookSelf: "Bạn không thể đặt lịch với chính mình.",
      privateArtist: "Hồ sơ artist này đang ở chế độ riêng tư nên không nhận đặt lịch.",
  ...
  EN: {
    ...
    home: {
      ...
      exploreSubtitle: "Browse every public makeup artist on Glamora.",
      quickBookTitle: "Quick booking",
      quickBookBody: "Pick a featured artist and send a request in minutes.",
